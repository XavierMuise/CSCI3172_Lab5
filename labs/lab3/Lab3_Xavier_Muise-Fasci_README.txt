...
* *Lab Timberlea URL*: <https://web.cs.dal.ca/~muisefasci/csci3172/labs/lab3/>
* *Lab Gitlab URL*: <https://git.cs.dal.ca/muisefasci/csci3172/-/tree/main/labs/lab3>
...
```
How can i remove specified item from an array in javascript 
