...
* *Lab Timberlea URL*: <https://web.cs.dal.ca/~muisefasci/csci3172/activities/lecture5/>
* *Lab Gitlab URL*: <https://git.cs.dal.ca/muisefasci/csci3172/-/tree/main/activities/lecture5>
...
* [Xavier Muise-Fasci](xv360378@dal.ca)
...
I used the completed version of the magic 8ball code that we worked on in class. index.html and style.css 
were completely downloaded. I modified the script.js to add the fortune cookie sayings 
